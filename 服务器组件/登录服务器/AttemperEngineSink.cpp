	...
	case SUB_GP_MODIFY_LOGON_PASS:		  //修改密码
		{
			...
			pModifyLogonPass->szPhone[CountArray(pModifyLogonPass->szPhone)-1]=0;
			...
			lstrcpyn(ModifyLogonPass.szPhone,pModifyLogonPass->szPhone,CountArray(ModifyLogonPass.szPhone));
