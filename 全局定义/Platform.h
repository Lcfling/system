...
//平台常量
const TCHAR szProduct[]=TEXT("816");							//产品名字
const TCHAR szPlazaClass[]=TEXT("762GamePlaza");						//广场类名
const TCHAR szProductKey[]=TEXT("762GamePlatform");					//产品主键

//地址定义
const TCHAR szCookieUrl[]=TEXT("http://www.xqn888.cn");					//记录地址
const TCHAR szLogonServer[]=TEXT("120.77.220.247");						//登录地址
const TCHAR szPlatformLink[]=TEXT("http://www.xqn888.cn");				//平台网站
